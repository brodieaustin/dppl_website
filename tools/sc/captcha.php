<?php
    ...
    echo '<style>body{margin: 0; padding: 0;}.captcha-wrap{width: 300px; height:80px; position: relative;} #reload-captcha{display: block; position: absolute; bottom: 0; right: 0; height: 16px; width: 15px; padding: 5px; background: #fff url(reload.png) no-repeat center center;}.alert{background-color: red;}</style>';
