    $(document).ready(function(){
        ...
        //{"job-title" : "Job Title"}
        var current_jobs = {"part-time-building-monitor" : "Part-Time Building Monitor", "part-time-building-and-security-services-assistant" : "Part-Time Building and Security Services Assistant", "shelver-m-f-12-3" : "Shelver M-F, 12-3", "shelver-m-f-3-6" : "Shelver M-F, 3-6", "part-time-reference-librarian" : "Part-time Reference Librarian", "readers-services-assistant" : "Readers' Services Assistant"};
        var param, pos;
