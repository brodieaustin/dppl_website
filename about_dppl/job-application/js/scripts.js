    $(document).ready(function(){
        ...
        //{"job-title" : "Job Title"}
        var current_jobs = {"part-time-building-monitor" : "Part-Time Building Monitor", "part-time-readers-services-assistant" : "Part-Time-Readers Services Assistant", "circulation-services-clerk" : "Circulation Services Clerk", "part-time-building-and-security-services-assistant" : "Part-Time Building and Security Services Assistant", "shelver-m-f-12-3" : "Shelver M-F, 12-3", "shelver-m-f-3-6" : "Shelver M-F, 3-6"};
        var param, pos;
