...
!function($) {
    ...
    SmartBanner.prototype = {
      ...
      , create: function() {
            ...
            $('body').append('<div id="smartbanner" class="'+this.type+'"><div class="sb-container"><a href="#" class="sb-close">&times;</a><span class="sb-icon"></span><div class="sb-info"><strong>'+this.title+'</strong><span>'+this.author+'</span><span>'+inStore+'</span></div><a href="'+link+'" class="sb-button track" data-ga-category="Mobile-Download" data-ga-action="' + this.type + '"><span>'+this.options.button+'</span></a></div></div>')
